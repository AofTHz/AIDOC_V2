<?php include('../AA_Project/Confirm_A/count_Stu.php'); ?>
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800 font-weight-bold"> <i class="fa-brands fa-phoenix-framework" style="color: DarkOrange;"></i> FS School<sup style="color: DodgerBlue;">Student</sup></h1>
    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
        Total student
        <div class="h5 mb-0 font-weight-bold text-gray-800 align-items-center justify-content-center ">
            <?php echo  $fetch['data_stu'] ?>
        </div>
    </div>
